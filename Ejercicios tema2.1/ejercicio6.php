...
printf("<div><h1> EL GANADOR DEL JUEGO HA SIDO EL %s </h1></div>",$ganador);
    ...
    $estiloBoton = "text-decoration: none; background-color: #f2f2f2; color: black; padding: 8px 12px; border: 1px solid #ccc; border-radius: 4px;";
    print("<a href=\"/Ejercicios%20tema2.1/ejercicio6.php\" style=\"{$estiloBoton}\">Recarga el juego</a>");
...
function tiradaDados($random) : void {
    ...
    switch ($random) {
      case 1:
          print(" <img src=\"/Ejercicios tema2.1/resources/1.jpg\" alt=\"Dado de valor 1\">   ");
          break;
      case 2:
          print(" <img src=\"/Ejercicios tema2.1/resources/2.jpg\" alt=\"Dado de valor 2\">   ");
          break;
      case 3:
          print(" <img src=\"/Ejercicios tema2.1/resources/3.jpg\" alt=\"Dado de valor 3\">   ");
          break;
      case 4:
          print(" <img src=\"/Ejercicios tema2.1/resources/4.jpg\" alt=\"Dado de valor 4\">   ");
          break;
      case 5:
          print(" <img src=\"/Ejercicios tema2.1/resources/5.jpg\" alt=\"Dado de valor 5\">   ");
          break;
      case 6:
          print(" <img src=\"/Ejercicios tema2.1/resources/6.jpg\" alt=\"Dado de valor 6\">   ");
          break;
